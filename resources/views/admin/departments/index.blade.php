<x-admin-layout>
    <div class="flex justify-between">
        <h1 class="text-2xl font-semibold p-4">All Departments</h1>
        <div class="p-4">
    ...
    <x-splade-table :for="$departments">
        @cell('action', $department)
            <div class="space-x-2">
                <Link href="{{ route('admin.departments.edit', $department) }}" class="text-white px-3 py-2 bg-green-400 hover:bg-blue-700 rounded-md">Edit</Link>
